...
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-21.1.3.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-21.1.3.tar.xz.sig
...
%prep
%setup -q -n xwayland-21.1.3
cd %{_builddir}/xwayland-21.1.3
%patch1 -p1
pushd ..
cp -a xwayland-21.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636389242
...
cp %{_builddir}/xwayland-21.1.3/COPYING %{buildroot}/usr/share/package-licenses/xwayland/11d1ae389a1a78f7832586e4c2a0c3c7263b7475
