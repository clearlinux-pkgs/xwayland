...
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-22.0.99.902.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-22.0.99.902.tar.xz.sig
...
%prep
%setup -q -n xwayland-22.0.99.902
cd %{_builddir}/xwayland-22.0.99.902
pushd ..
cp -a xwayland-22.0.99.902 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643819244
...
cp %{_builddir}/xwayland-22.0.99.902/COPYING %{buildroot}/usr/share/package-licenses/xwayland/11d1ae389a1a78f7832586e4c2a0c3c7263b7475
