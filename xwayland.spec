...
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-22.1.6.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-22.1.6.tar.xz.sig
...
%prep
%setup -q -n xwayland-22.1.6
cd %{_builddir}/xwayland-22.1.6
pushd ..
cp -a xwayland-22.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671086617
