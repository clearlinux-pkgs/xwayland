...
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-23.2.3.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-23.2.3.tar.xz.sig
...
%prep
%setup -q -n xwayland-23.2.3
cd %{_builddir}/xwayland-23.2.3
pushd ..
cp -a xwayland-23.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702926575
