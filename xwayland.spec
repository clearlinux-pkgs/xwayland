...
Version  : 23.2.1
Release  : 42
URL      : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-23.2.1.tar.xz
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-23.2.1.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-23.2.1.tar.xz.sig
...
%prep
%setup -q -n xwayland-23.2.1
cd %{_builddir}/xwayland-23.2.1
pushd ..
cp -a xwayland-23.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695227535
