...
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-24.1.2.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-24.1.2.tar.xz.sig
...
%setup -q -n xwayland-24.1.2
cd %{_builddir}/xwayland-24.1.2
pushd ..
cp -a xwayland-24.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723045331
