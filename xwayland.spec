...
Source0  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-24.1.1.tar.xz
Source1  : https://xorg.freedesktop.org/archive/individual/xserver/xwayland-24.1.1.tar.xz.sig
...
%setup -q -n xwayland-24.1.1
cd %{_builddir}/xwayland-24.1.1
pushd ..
cp -a xwayland-24.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720656704
